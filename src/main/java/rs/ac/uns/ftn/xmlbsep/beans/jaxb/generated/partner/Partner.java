...
public class Partner extends AbstractBaseEntity<String> {
    ...
    /**
     * Gets the value of the baseRestUrl property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the baseRestUrl property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setBaseRestUrl(String value) {
     ...
     * 
     */
    public List<Partner.Account> getAccount() {
        if (account == null) {
            account = new ArrayList<Partner.Account>();
        }
        return this.account;
    }
