...
public class BsDocumentService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Nikola/Documents/Fakultet/XWS/projekat/NiceHead/Banka/WEB-INF/wsdl/bs.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BsDocumentService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Nikola/Documents/Fakultet/XWS/projekat/NiceHead/Banka/WEB-INF/wsdl/bs.wsdl");
        }
        WSDL_LOCATION = url;
    }
