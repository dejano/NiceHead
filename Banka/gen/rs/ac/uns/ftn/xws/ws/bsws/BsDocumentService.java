...
public class BsDocumentService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Bandjur/Desktop/Workspace/XWS-BSEP-PI/XWS/NiceHead/Banka/WEB-INF/wsdl/bstatement.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BsDocumentService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Bandjur/Desktop/Workspace/XWS-BSEP-PI/XWS/NiceHead/Banka/WEB-INF/wsdl/bstatement.wsdl");
        }
        WSDL_LOCATION = url;
    }
