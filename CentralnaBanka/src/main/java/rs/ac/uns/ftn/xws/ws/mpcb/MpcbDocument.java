...
public interface MpcbDocument {
    ...
    public rs.ac.uns.ftn.xws.generated.Mt900 rtgsRequest(
        @WebParam(partName = "rtgsRequestPart", name = "mt102", targetNamespace = "http://www.ftn.uns.ac.rs/xws/xsd/mt102")
    ...
    public rs.ac.uns.ftn.xws.generated.Mt900 clearingRequest(
        @WebParam(partName = "clearingRequestPart", name = "mt103", targetNamespace = "http://www.ftn.uns.ac.rs/xws/xsd/mt103")
