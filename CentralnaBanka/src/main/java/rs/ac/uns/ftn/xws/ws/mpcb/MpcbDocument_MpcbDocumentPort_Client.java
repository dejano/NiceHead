...
import rs.ac.uns.ftn.xws.generated.ObjectFactory;
...
public final class MpcbDocument_MpcbDocumentPort_Client {
    ...
    public static void main(String args[])  {
    	try {
			...
			Mt103 m = new Mt103();
			m.setAmount(new BigDecimal(22));
			
			BankDetails bdd =new BankDetails();
			bdd.setSwiftCode("CONARS22");
			m.setDebtorBankDetails(bdd);

			BankDetails bdc =new BankDetails();
			bdc.setSwiftCode("CONARS23");
			m.setCreditorBankDetails(bdc);
			
			mpcbService.clearingRequest(m);
