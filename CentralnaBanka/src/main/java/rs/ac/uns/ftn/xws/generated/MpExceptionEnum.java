...
/**
 * <p>
 * Java class for MpExceptionEnum.
 * 
 * <p>
...
public enum MpExceptionEnum {
	...
	INVALID_SWIFT_CODE("invalidSwiftCode"), @XmlEnumValue("invalidAmount")
	INVALID_AMOUNT("invalidAmount"), @XmlEnumValue("multipleBanks")
	MULTIPLE_BANKS("multipleBanks"), @XmlEnumValue("debtorBankHasInsufficientFunds")
